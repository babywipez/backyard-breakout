...
const Navbar = () => {
  ...
  return (
    <>
      {/* Top Header Section */}
      <section className="w-full bg-custom-gray text-custom-black px-4">
      ...
      <header className="bg-custom-black flex items-center h-[74px] py-0 px-3 w-full border-b-4 border-solid border-custom-gray lg:px-6">
        <section className="flex items-center">
          ...
          {/* Divider Line */}
          <section className="max-w-[50px] opacity-70 hidden lg:block">
            <svg
              width="100%"
              height="100%"
              viewBox="0 0 24 24"
        ...
        <nav
          ref={navRef}
          className="bg-custom-black text-custom-white flex items-center text-2xl top-0 left-0 h-full flex-col justify-center gap-6 w-0 lg:w-auto lg:flex-row lg:gap-0 lg:text-[1rem] lg:ml-4"
        >
          <Link
            to="/"
            className="my-0 mx-6 no-underline opacity-80 hover:text-blue-400"
            onClick={hideNavbar}
          >
            Home
          </Link>
